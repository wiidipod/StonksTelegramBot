...
def analyze(df, ticker, future=250, full=False, pe_ratios=None):
    ...
    if price_target is not None or peg_ratio is not None or pe_ratio is not None or ev_to_ebitda is not None or (sl is not None and tp is not None) or score is not None:
        subtitle = ''
